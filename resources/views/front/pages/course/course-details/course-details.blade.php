    ...
    <section class="w-100 bg-warning-subtle">
        <div class="container">
            <div class="d-flex justify-content-start align-items-center height-350">
                <div>
                    <div class="fs-1 fw-bold text-theme-secondary mb-3 d-block">
            ...
            <div class="row">
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="fs-4 fw-bold text-theme-secondary mb-3">
                                            Course Description
                                        </div>
                                        ...
                                        <div class="fs-4 fw-bold text-theme-secondary mb-4">
                                            What you will learn
                                        </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-4 bg-white shadow rounded-4 sticky-top z-0" style="top: 120px">
                        ...
                        <div class="text-theme p-3 fw-medium">
                            <span class="me-2">

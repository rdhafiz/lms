...
@section('content')
    ...
    <div class="card bg-white border rounded-3 overflow-hidden">
        ...
        <div class="card-header p-3 bg-white border-0 rounded-0 border-bottom">
            <h5 class="h5 mb-0 fw-medium"> User Management </h5>
        </div>

        {{-- User management card body as data list --}}
        ...
        {{-- User management card footer as pagination --}}
    ...
    {{-- Manage Modal of user create and edit --}}
